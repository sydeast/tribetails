...
/**
 * Shared tone enums for the Den component kit. Centralized so every component
 * (chips, status pills, banners, icon tiles) resolves to the SAME brand colors.
 * Resolvers take [AuntieColors] (from AuntieTheme.colors) and return a Color.
 */
