...
/**
 * JVM (desktop): no localStorage equivalent wired up here, so per-device
 * dismissals are held in a process-lifetime in-memory set (holds for the
 * session, not across app restarts). See [BannerDismissStore] for rationale.
 */
