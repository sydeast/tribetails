 ...
 * pattern). A subset of the doc (formValues/checklist/timestamps omitted); every
 * field is defaulted so a legacy/partial doc never renders `undefined`.
 */
...
const EMPTY: Omit<KinDetail, '_id'> = {
  ...
  medicationHealthNotes: '', vetInfo: '', officeNotes: '', ownerEmail: '', ownerPhone: '',
};
