 ...
 * recognized we collapse whitespace and truncate, so the profile subtitle never runs long.
 *
 * Real data ("Text", "Email") passes through unchanged.
 */
internal fun preferredContactSummary(raw: String): String {
