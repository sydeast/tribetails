...
export function parseArgs(argv: string[]): Args {
  ...
  // is safe before it rewrites a recorded creation instant that nothing else
  // can reconstruct once overwritten; getting its precedence backwards
    ...
    if (a === '--allow-prod') args.allowProd = true;
      ...
      console.log(
        [
          ...
          '  npm run backfill:kintale-provenance -- --dry-run       # force dry-run, ALWAYS wins',
