...
/**
 * Pure-helper tests for [mediaMetaLine] (spec 28 item 3): the caption meta line
 * surfaces real uploadedAt (date prefix) + uploadedBy, dropping blank or
 * fabricated ("auntie") parts rather than printing them.
 */
