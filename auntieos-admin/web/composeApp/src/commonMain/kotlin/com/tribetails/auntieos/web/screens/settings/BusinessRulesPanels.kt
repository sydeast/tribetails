...
/**
 * The first thing wrong with these rows, or null.
 *
 ...
 * same-day range, so a "22:00-02:00" block would match nothing at all and the
 * operator would never be told why.
 */
...
internal fun BookingRulesPanel(
    ...
    var blocks by remember(s) { mutableStateOf(s?.timeBlocks.orEmpty().map { it.toRow() }) }
