...
/**
 * The terms resolver's fixture table, run over the MIRROR. THE SAME CASES AND THE SAME EXPECTED DAYS
 * run in `mytribe/functions/test/invoiceTerms.test.ts` over the authority, so a
