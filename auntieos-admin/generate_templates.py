...
keys = [
    ...
    # account.welcome.business was retired on 2026-08-18 at the operator's request.
    # Regenerating a row here would put back the template they deliberately deleted.
