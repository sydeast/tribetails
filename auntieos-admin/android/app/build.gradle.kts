...
tasks.register("verifyGrpcVersionPins") {
    doLast {
        ...
        logger.lifecycle("gRPC version pins OK (grpc-api/core/context all at 1.84.0)")
    }
}
...
configurations.all {
    resolutionStrategy {
        force("io.grpc:grpc-api:1.84.0")
        force("io.grpc:grpc-context:1.84.0")
        force("io.grpc:grpc-core:1.84.0")
    }
}
